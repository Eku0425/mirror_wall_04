                                  ...
                                  RadioListTile(
                                    ...
                                    onChanged: (value) {
                                      ...
                                      webViewController!.loadUrl(
                                          urlRequest: URLRequest(
                                              url: WebUri(
                                                  'https://www.${SearchController.search.value}.com/')));
                                      Timer(
                                        Duration(
                                          seconds: 1,
                                        ),
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    onFieldSubmitted: (value) {
                      SearchController.setData(value,
                          'https://www.${SearchController.search.value}.com/search?q=${value}');
                      webViewController!.loadUrl(
                          urlRequest: URLRequest(
                              url: WebUri(
                                  'https://www.${SearchController.search.value}.com/search?q=${value}')));
      ...
      bottomNavigationBar: Row(
        ...
        children: [
          ...
          IconButton(
              onPressed: () {
                if (data != null) {
                  SearchController.setData(data!,
                      'https://www.${SearchController.search.value}.com/search?q=$data');
                }
              },
